...
public class ApplyJobSendMailUtility {
...
static String password;
  ...
  try {  
   ...
   message.setSubject("Job Seeker has shown interest in the Job you Posted");  
   message.setContent("<h1>Job applied by a Job Seeker</h1>","text/html" ); 
