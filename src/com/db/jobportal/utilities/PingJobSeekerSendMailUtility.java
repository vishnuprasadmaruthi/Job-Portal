...
public class PingJobSeekerSendMailUtility {
...
static String password;
  ...
  try {  
   ...
   message.setSubject("Job Enabler is showing interest in your profile.");  
   message.setContent("<h1>Ping back Job Enabler for more information and help.</h1>","text/html" ); 
